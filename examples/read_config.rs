...
use liban::{AnppParser, Packet, PacketKind, Request};
use std::{
    io::{Read, Write},
    net::TcpStream,
    thread,
...
fn main() -> Result<(), Box<dyn std::error::Error>> {
    ...
    loop {
        ...
        while let Some(packet) = parser.consume(input) {
            input = &[];
            match packet {
                Packet::DeviceInformation(info) if received_configs.insert("DeviceInformation") => {
                    println!("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
                ...
                Packet::FilterOptions(opts) if received_configs.insert("FilterOptions") => {
                    println!("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
                ...
                Packet::InstallationAlignment(align) if received_configs.insert("InstallationAlignment") => {
                    println!("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
                ...
                Packet::IpConfiguration(ip_config) if received_configs.insert("IpConfiguration") => {
                    println!("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
                ...
                Packet::PacketTimerPeriod(timer) if received_configs.insert("PacketTimerPeriod") => {
                    println!("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
                ...
                Packet::PacketsPeriod(periods) if received_configs.insert("PacketsPeriod") => {
                    println!("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
                ...
                Packet::OdometerConfiguration(odom) if received_configs.insert("OdometerConfiguration") => {
                    println!("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
                ...
                Packet::ReferencePointOffsets(offsets) if received_configs.insert("ReferencePointOffsets") => {
                    println!("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
                ...
                Packet::IpDataportsConfiguration(dataports) if received_configs.insert("IpDataportsConfiguration") => {
                    println!("━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━");
